...
const SelectNetworkModal = () => {
  const {
    ...
    message: "Sign this message to authenticate with Tria",
    chainName: "POLYGON",
  });
  ...
  useEffect(() => {
    setSelectedItemFinalPrice(selectedItemAmount * selectedItemPrice);
  }, []);*/
              ...
              <div className="relative bg-gradient-to-r from-rose-50 to-teal-50 rounded-lg shadow">
                <button
                  ...
                  onClick={() => {
                    ...
                    setPriceETH(undefined);
                    setPriceBNB(undefined);
                    setPriceAVAX(undefined);
                    setPriceMATIC(undefined);
                  }}
                >
                  <svg
                    aria-hidden="true"
                  ...
                  <div className="flex flex-row bg-gray-100 rounded-lg items-center cursor-default">
                    ...
                    <div className="pt-2 font-bold font-inter text-gray-900 text-xl leading-none">
                      ...
                      <p className="font-inter font-normal text-gray-900 text-base">
                        ...
                        {selectedItemAmount} x ${selectedItemPrice} ={" "}
                        <span className="font-semibold">
                          ${Number(selectedItemFinalPrice).toFixed(2)}
                        </span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="my-4 space-y-3 list-inside">
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          await itemContractEthereum.methods
                            .mint(selectedItemID, selectedItemAmount)
                            .send({
                              from: accounts[0],
                    ...
                    >
                      ...
                      {!isShownETH ? (
                        ...
                        >
                          {/*Number(priceETH).toFixed(3) ETH*/} SOON!
                        </button>
                      ) : (
                        <button
                          type="button"
                    ...
                    <div
                      className="hover:scale-105 transition delay-150 duration-300 ease-in-out cursor-pointer no-underline hover:no-underline flex items-center p-2 text-base font-bold text-gray-900 hover:text-gray-900 bg-gray-200 rounded-lg hover:bg-gray-300 group hover:shadow"
                      onClick={async () => {
                        /* if (wsWeb3Client.readyState === 1)
                          wsWeb3Client.send("yooo");
...
*/
                    ...
                    >
                      ...
                      {!isShownAVAX ? (
                        ...
                        >
                          {Number(priceAVAX).toFixed(3)} AVAX
                        </button>
                      ) : (
                        <button
                          type="button"
                    ...
                    >
                      ...
                      {!isShownMATIC ? (
                        ...
                        >
                          {Number(priceMATIC).toFixed(3)} MATIC
                        </button>
                      ) : (
